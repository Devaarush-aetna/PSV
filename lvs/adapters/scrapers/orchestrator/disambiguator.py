...
def provider_type_matches(prov_type: str, candidate_license_type: str,
    ...
    expansions = {
        ...
        "NP": ("NURSE PRACTITIONER", "ADVANCED PRACTICE", "ARNP", "APRN", "PRESCRIPTIVE AUTHORITY", "ADVANCED REGISTERED", "REGISTERED NURSE PRACTITIONER", "DELEGATING NURSE","ADVANCED PRACTICE REGISTERED NURSE","CHIROPRACTOR LICENSE", "REGISTERED NURSE"),
        ...
        "PN": ("PRACTICAL NURSE", "LPN", "LICENSED PRACTICAL", "ADVANCED PRACTICE REGISTERED NURSE", "REGISTERED NURSE", "ADV. PRACTICE NURSE - RESIDENT", "APRN CNP PSYCHIATRIC", "CSR-APRN", "APRN"),
        ...
        "DC": ("CHIROPRACT",),
        "DAC": ("ADDICTION COUNSEL", "DRUG ABUSE", "SUBSTANCE ABUSE", "ALCOHOL AND DRUG", "DRUG AND ALCOHOL", "SUBSTANCE USE DISORDER PROFESSIONAL CERTIFICATION", "LADC/MENTAL HEALTH", "LADC/MH"),
        "AP": ("ACUPUNCTUR", "ORIENTAL MEDICINE", "LAC", "DOM", "OMD"),
        "AU": ("AUDIOLOGIST", "AUDIOLOGY"),
        "SH": ("HEARING AID", "AUDIOLOGY", "AUDIOLOGIST", "SPEECH AND LANGUAGE PATHOLOGIST", "SPEECH LANGUAGE", "SLP", "SPEECH-LANGUAGE PATHOLOGY", "SPEECH/LANG"),
