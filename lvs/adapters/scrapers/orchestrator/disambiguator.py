...
def provider_type_matches(prov_type: str, candidate_license_type: str,
    ...
    expansions = {
        ...
        "NP": ("NURSE PRACTITIONER", "ADVANCED PRACTICE", "ARNP", "APRN", "PRESCRIPTIVE AUTHORITY", "ADVANCED REGISTERED", "REGISTERED NURSE PRACTITIONER", "DELEGATING NURSE","ADVANCED PRACTICE REGISTERED NURSE","CHIROPRACTOR LICENSE"),
